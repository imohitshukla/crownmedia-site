...
export default function Footer() {
  return (
    <footer className="bg-zinc-950 relative border-t border-white/5 pt-16 pb-8">
      {/* subtle gradient top border highlight */}
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
          ...
          <div className="text-center md:text-left">
            <Link href="/" className="text-2xl font-bold tracking-tight flex items-center justify-center md:justify-start gap-2 mb-2">
              ...
              <span className="text-gray-400 font-medium">Media</span>
            </Link>
            <p className="text-gray-500 text-sm">Crafted by humans, for humans.</p>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Crown Media. All rights reserved.</p>
